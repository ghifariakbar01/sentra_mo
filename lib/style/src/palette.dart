...
class Palette {
  static const primaryColor = Color(0xFF1C3F99);

  static const primaryColorSecondary = Color(0xFFD2D9EB);

  static const primaryDarkColor = Color.fromARGB(255, 127, 0, 201);
  ...
  static const secondaryTextColor = Color.fromARGB(255, 214, 214, 214);
